...
@defcomp DamageAggregator begin
    ...
    include_smoke = Parameter{Bool}(default=true) # default TRUE # include smoke damages
    ...
    smoke_damage                    = Variable(index=[time], unit="US\$2005/yr")
    ...
    smoke_damage_domestic                    = Variable(index=[time], unit="US\$2005/yr")
  
    function run_timestep(p, v, d, t)

        ## global annual aggregates - for interim model outputs and partial SCCs
        v.smoke_damage[t]                   = sum(p.damage_smoke[t,:])
        ...
        v.total_damage[t] =
            ...
            (p.include_smoke            ? v.smoke_damage[t] : 0.) +
        ...
        v.smoke_damage_domestic[t]                      = p.damage_smoke[t,174]
        ...
        v.total_damage_domestic[t] =
            ...
            (p.include_smoke            ? v.smoke_damage_domestic[t] : 0.)
    end
end
