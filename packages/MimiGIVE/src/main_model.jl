...
function get_model(; Agriculture_gtap::String = "midDF",
                    ...
                    vsl::Symbol= :epa,
                    smoke_damages_crf::Union{String, Nothing} = nothing
                )
    ...
    # Add Smoke PM2.5 component
    add_comp!(m, smoke_damages, :Smoke, first = damages_first, after = :CromarMortality)

    # Add Agriculture components
    add_comp!(m, Agriculture_RegionAggregatorSum, :Agriculture_aggregator_population, first = damages_first, after = :Smoke);
